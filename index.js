...
• https://instagram.com/jack_paymon?utm_medium=copy_link

• https://instagram.com/w6y.x9v?utm_medium=copy_link
...
▢ ${msg.gp} 1
https://chat.whatsapp.com/CaO44IikBbt7Fbc4l8GhKs
...
/*number = '18295176783@s.whatsapp.net'
    ...
    await Fg.fakeLink(from, capt, thumbfg, `${msg.click}`, 'https://instagram.com/jack_paymon?utm_medium=copy_link', mek)*/
   Fg.sendContact(from, '18295176783', 'Jacksito', mek) 
    break
...
*≡ OWNER*
▢ Instagram : https://instagram.com/jack_paymon?utm_medium=copy_link
▢ WhatsApp : wa.me/18295176783 

*≡ Mi canal*
▢ link: https://www.youtube.com/channel/UCTfpv-KmckjC1rwPKqw_t1w 
` 
Fg.send2Button(from, teks, '*_© Jacksito98*', `ꨄ︎ Apoyar`, `${prefix}donate`, `⌬ ${msg.gp}s`, `${prefix}grupos`)
   break
